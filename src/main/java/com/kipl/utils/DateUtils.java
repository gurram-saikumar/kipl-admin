...
public final class DateUtils
{
     ...
     */
    public final SimpleDateFormat yyyyMMDDTIME = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss.SS");
    ...
    public static final SimpleDateFormat dd_MMM_yyyy_FORMAT1 = new SimpleDateFormat("dd MMM yyyy");
    public static final SimpleDateFormat YYMMDD_FORMAT = new SimpleDateFormat("yyMMdd");
    public static final SimpleDateFormat dd_MMM_yyyy_FORMAT2 = new SimpleDateFormat("dd MMM yyyy hh:mm a");
    public static final SimpleDateFormat yyyy_MMM_dd_FORMAT3 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    public static final SimpleDateFormat dd_MMM_yyyy_FORMAT4 = new SimpleDateFormat("dd MMM yyyy hh:mm:ss a");
...
//    }
    ...
    public String format(Timestamp timestamp, String format)
    {
        try
        {
            if (format == null)
            ...
            SimpleDateFormat sdf = yyyyMMDDTIME;
    ...
    public static String getdatefromTimeStampAsddMMMyyyy(Timestamp timestamp) {
    	if(timestamp!=null)
        return dd_MMM_yyyy_FORMAT1.format(timestamp.getTime());
    	else
    		return null;
    }
    ...
    public static String getdateAsYYMMDDfromTimeStamp(Timestamp timestamp) {
    	if(timestamp!=null)
        return YYMMDD_FORMAT.format(timestamp.getTime());
    	else
    		return null;
    }
	
    public static String getdateDDMMMYYYYFromTimestamp(Timestamp timestamp) {
    	if(timestamp!=null)
        return dd_MMM_yyyy_FORMAT2.format(timestamp.getTime());
    	else
    		return null;
    }
    ...
    public static String getStringTImeStampFromTimestamp(Timestamp timestamp) {
    	if(timestamp!=null)
        return yyyy_MMM_dd_FORMAT3.format(timestamp.getTime());
    	else
    		return null;
    }
    
    public static String getdateDDMMMYYYYFromTimestampWithMillis(Timestamp timestamp) {
    	if(timestamp!=null)
        return dd_MMM_yyyy_FORMAT4.format(timestamp.getTime());
    	else
    		return null;
    }
	...
	public static String formatTo12HourWithDate(Timestamp timestamp)
    {
        try
        {
	...
	public static String formatTo12HourWithDate(String dateStr) {
        ...
        String[] dateFormats = {
            ...
            "yyyy-MM-dd"                  // only date part
        };

        // Try each format to parse the input string
        Date date = null;
        for (String format : dateFormats) {
            ...
            try {
                ...
                // Ignore this exception and try the next format
                continue;
            }
        }

        if (date == null) {
            // If no format matched, log error and return null
        	LOG.error("Invalid date format: " + dateStr);
            return null;
        }

        // Define the output format to 12-hour format with AM/PM
	...
	public static int getYearFromSqlTimestamp(Timestamp timestamp) {
		LocalDateTime dateTime = timestamp.toLocalDateTime();
		return dateTime.getYear();
	}
	
	  // Method to extract the year from both Date objects and return as a string
    public static String getSeasonDuration(Date fromDt, Date toDt) {
        // Create a Calendar instance to extract the year from both dates
        Calendar calendar = Calendar.getInstance();
        
        // Extract year from fromDt
        calendar.setTime(fromDt);
        int fromYear = calendar.get(Calendar.YEAR);

        // Extract year from toDt
